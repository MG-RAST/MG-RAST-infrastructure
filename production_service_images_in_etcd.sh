...
#api-server-[channel]
#CHANNEL: api
curl -L http://127.0.0.1:2379/v2/keys/service_images/api-server-api/shock -XPUT -d value="shock.metagenomics.anl.gov/node/41e55ca2-42a6-42d7-9bd7-6a03915a3769"
